...
# 【3】绘制筛选后的边界框
def draw_detection(im, bboxes, scores, cls_inds, labels, colors, thr=0.3):
    # draw image
    imgcv = np.copy(im)
    h, w, _ = imgcv.shape
    for i, box in enumerate(bboxes):
        ...
        cv2.rectangle(imgcv,(box[0], box[1]), (box[2], box[3]),(74, 120, 237),thick)
        ...
        cv2.putText(imgcv, mess, text_loc, cv2.FONT_HERSHEY_SIMPLEX, 1e-3*h, (184, 166, 51), thick)        
    return imgcv
